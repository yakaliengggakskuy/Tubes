class QuranModel {
  ...
  QuranModel({this.code, this.status, this.message, this.data});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    revelation = json['revelation'] != null
        ...
        : null;
    tafsirSurah = json['tafsirSurah'] != null
        ? new TafsirSurah.fromJson(json['tafsirSurah'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.tafsirSurah != null) {
      data['tafsirSurah'] = this.tafsirSurah!.toJson();
    }
